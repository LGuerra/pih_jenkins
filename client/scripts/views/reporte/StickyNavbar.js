      ...
      <div id={'sticky-nav'} style={{
        ...
        <div style={{display: 'flex', alignItems: 'center'}}  className={'row'}>
          <div className={'col-sm-4'}>
            <p style={{alignSelf: 'flex-end'}}>{'Mariano Escobedo #748 col. Anzures Miguel Hidalgo, D.F. C.P. 11590'}</p>
          </div>
          <div className={'col-sm-8'}>
            <div className={'navbar-icons'}>
              ...
              <div className={'navbar-icon'}>
                ...
                <p style={{fontSize: '12px', margin: '0px 5px 0px 5px'}}>{'1'}</p>
                <p style={{fontSize: '12px', margin: '0px 5px 0px 0px'}}>{'m² en Construcción'}</p>
              </div>
            </div>
          </div>
        </div>
